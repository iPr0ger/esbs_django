    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(default=datetime.datetime.utcnow)),
                ('list_order', models.IntegerField(default=0)),
                ('feature_type', models.ForeignKey(blank=True, db_column='feature_type_id', db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='study_feature_categories_feature_type_id', to='context.studyfeaturetypes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=75, unique=True)),
                ('list_order', models.IntegerField(default=0)),
                ('role_class', models.ForeignKey(blank=True, db_column='role_class_id', db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='role_types_role_class_id', to='context.roleclasses')),
            ],
            options={
                'db_table': 'role_types',
                'ordering': ['list_order'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(db_index=True, default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('name', models.CharField(db_index=True, max_length=75, unique=True)),
                ('org_class', models.ForeignKey(blank=True, db_column='class_id', db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='org_types_class_id', to='context.orgclasses')),
            ],
            options={
                'db_table': 'org_types',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_attribute_datatype', models.ForeignKey(blank=True, db_column='org_attribute_datatype_id', db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='org_attribute_types_org_attribute_datatype_id', to='context.orgattributedatatypes')),
                ('parent_id', models.ForeignKey(blank=True, db_column='parent_id', db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='org_attribute_types_parent_id', to='context.orgattributetypes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('list_order', models.IntegerField(default=0)),
                ('use_in_data_entry', models.BooleanField(default=True)),
                ('filter_as', models.ForeignKey(blank=True, db_column='filter_as_id', db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='object_types_filter_as_id', to='context.objectfiltertypes')),
                ('object_class', models.ForeignKey(blank=True, db_column='object_class_id', db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='object_types_object_class_id', to='context.objectclasses')),
            ],
            options={
